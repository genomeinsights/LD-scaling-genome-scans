######################################################
##  Takes parsed data from "./parsed_data" generated by ./R_simulations/Parse_raw_data_sim.R
...
##
## I usually run this by calling Rscript from command line and use TRUE/FALSE for which analyses I'm running
######################################################
...
#----------------------------------------------------------
## false positives ##
top_10[,FP_QTN:=FP-FP_ntrl]

dt <- melt(top_10, measure.vars = c("FN","TP","PR","FP_QTN","FP_ntrl","precision","recall"))
dt <- dt[,.(value=mean(value)),.(sim, gene_flow, selection_intensity,base_method,AUC_meth, rep,variable)]

dt[variable=="FP_QTN" ,variable:="FP[QTN]"]
...
pdf("./Figures/Separately.pdf",width = 12,height = 10)
p_sep
dev.off()
